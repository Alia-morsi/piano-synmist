...
if __name__ == '__main__':
    # setting argparse to take in path to the midi file
    import argparse
    ...
    # mist = Mistaker('/Users/huanzhang/01Acdemics/PhD/Research/SynthMistakes/data_processing/Alfreds_1/2._Seaside_Stroll.mid')
